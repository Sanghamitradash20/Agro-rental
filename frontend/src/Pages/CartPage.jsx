...
// import { Box, Heading, Text, Button, Flex, Divider, Center,ChakraProvider } from '@chakra-ui/react';
...
const CartPage = () => {
  ...
  const { cartItems, clearCart, getTotal } = useCart(farmerId);

  const handleClearCart = async () => {
    try {
      await axios.delete('/api/cart/clear'); // Assuming your clearCart function is correctly implemented in the backend
      clearCart();
    } catch (error) {
